            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="widget subscribe no-box">
                        <h5 class="widget-title"><i class="fa-2x fad fa-burger-soda mr-2"></i>Food Site<span></span></h5>
                        <p>Delivering the delicious food all over the College Campus.. </p>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="widget no-box">
                        ...
                        <ul class="thumbnail-widget">
                            <li>
                                <div class="thumb-content"><router-link to="/">Home Page</router-link></div>
                            </li>
                            <li>
                                <div class="thumb-content"><router-link to="/profile/orders">Orders</router-link></div>
                            </li>
                            <li>
                                <div class="thumb-content"><router-link to="/profile">Profile</router-link></div>
                            </li>
                            <li>
                                <div class="thumb-content"><router-link to="/profile/settings">Settings</router-link></div>
                            </li>
                            <li>
                                <div class="thumb-content"><router-link to="/search">Serach Food</router-link></div>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    ...
                    <div class="widget no-box">
                        ...
                        <p><a href="mailto:travish4052@gmail.com" title="glorythemes">contact@foodsite.com</a></p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <p>Copyright Food Site © {{ new Date().getFullYear() }}. All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
