...
console.log('%cMade by Travis. Using Firebase, VueJS, NodeJS and MongoDB', warningDescCSS);
console.log('%cGo to https://github.com/travisdev6/food-order-app for source code.', warningDescCSS);
